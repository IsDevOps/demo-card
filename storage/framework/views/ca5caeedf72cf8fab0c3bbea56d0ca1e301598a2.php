                                                ...
                                                <?php if(in_array('block settings '.$module,(array) $permissions)): ?>
                                                    <?php if($key = array_search('block settings '.$module,$permissions)): ?>
                                                        <div class="col-md-3 form-check">
                                                            ...
                                                            <?php echo e(Form::label('permission'.$key,'Block setting',['class'=>'form-check-label'])); ?><br>
                                                        </div>
                                                    <?php endif; ?>
                                                <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/role/create.blade.php ENDPATH**/ ?>