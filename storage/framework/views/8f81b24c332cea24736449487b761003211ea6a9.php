...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme5'][$business->theme_color]['theme_name']); ?>"
        ...
        <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>" class="btn btn-primary add-to-contact-btn add-to-contact-botton" style="padding: 20px 47px"><i class="fa fa-address-card"></i>&nbsp; Add <span style="text-transform:lowercase; margin: 0 3px;"> to </span> Contact</a>
    </div>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme5/index.blade.php ENDPATH**/ ?>