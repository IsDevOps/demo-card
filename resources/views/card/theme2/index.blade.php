...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('custom/theme2/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/theme2/fonts/stylesheet.css') }}">
    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('custom/theme2/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme2/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('custom/theme2/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme2/css/responsive.css') }}">
    @endif
...
<body class="tech-card-body ">
    <div class="{{ \App\Models\Utility::themeOne()['theme2'][$business->theme_color]['theme_name'] }}"
        id="view_theme12">
        <main id="boxes">
                        ...
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-name">
                                        <h3 id="{{ $stringid . '_title' }}_preview" class="text-white">
                                            {{ $business->title }}</h3>
                                        <p id="{{ $stringid . '_designation' }}_preview" class="text-white">
                                            {{ $business->designation }}
                                        </p>
                                        <h6 id="{{ $stringid . '_subtitle' }}_preview" class="text-white">
                                            {{ $business->sub_title }}</h6>
                                    </div>
                                </div>
                                <div class="text-center desc-wrapper">
                                    <p id="{{ $stringid . '_desc' }}_preview" class="text-white">
                                                            ...
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    <a href="{{ $href }}" target="_blank">
                                                                        <span>
                                                                            <img src="{{ asset('custom/theme2/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        @foreach ($val1 as $key2 => $val2)
                                                                            @if ($key2 == 'Address')
                                        ...
                                        <div id="inputrow_gallery_preview">
                                            ...
                                            @else
                                                <div class="gallery-slider">
                                                    @if (!is_null($gallery_contents) && !is_null($gallery))
                                                        @foreach ($gallery_contents as $key => $gallery_content)
                                                            <div id="gallery_{{ $gallery_row_no }}">
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('custom/theme2/icon/social/' . strtolower($social_key1) . '.svg') }}"
                        ...
                        @if ($is_branding_enabled)
                            <div class="card-footer">
                                <div id="is_branding_enabled" class="is_branding_enable copy-right">
                                    <p id="{{ $stringid . '_branding' }}_preview">
    ...
    <!--scripts start here-->
    <script src="{{ asset('custom/theme2/js/jquery.min.js') }}"></script>

    <script src="{{ asset('custom/theme2/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('custom/theme2/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('custom/theme2/js/custom.js') }}" defer="defer"></script>
    @endif
