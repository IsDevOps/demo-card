        ...
        if (\Auth::check()) {
                ...
                if (!file_exists(storage_path() . "/installed")) {
                    ...
                    if (\Auth::user()->type == 'super admin') {
						...
						//dd($user_platform, $user_browser, $user_device);
                        $devicearray = [];
                        $devicearray['label'] = [];
                        $devicearray['data'] = [];
						...
						//dd($chartData);
						//dd($platformarray, $chartData, $browserarray, $devicearray);
                        return view('dashboard.dashboard', compact('total_bussiness', 'total_app', 'visitor_url', 'devicearray', 'browserarray', 'platformarray', 'chartData', 'cards', 'businessData', 'qr_detail', 'total_staff','user'));
