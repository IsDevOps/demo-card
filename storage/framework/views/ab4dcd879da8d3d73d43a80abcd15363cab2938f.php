...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme21/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme21/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />

    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme21/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme21/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme21/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme21/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme21/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme21'][$business->theme_color]['theme_name']); ?>"
            id="view_theme10">
                    ...
                    <div class="container">
                        <div class="client-info-wrapper bg-white">
                            <div class="client-intro text-center">
                                ...
                                <h3 id="<?php echo e($stringid . '_title'); ?>_preview" class="text-black"><?php echo e($business->title); ?>
                ...
                <?php $__currentLoopData = $card_theme->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($j == $order_value): ?>
                                                    ...
                                                    <?php if($key1 != 'id'): ?>
                                                        ...
                                                        <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <span><?php if($key1 == 'Web_url'): ?><?php echo e(__('Web Url')); ?> <?php else: ?><?php echo e(__($key1)); ?><?php endif; ?></span>
                                                                </a>
                                                            <?php endif; ?>
                                                        </li>
                                                    <?php endif; ?>
                        ...
                        <?php if($order_key == 'description'): ?>
                            <section class="client-text-section padding-top description-div" id="description-div">
                                <div class="container">
                                                            ...
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <div>
                                                                    <a href="<?php echo e($social_links); ?>"
                                                                        ...
                                                                        target="_blank">
                                                                        <img src="<?php echo e(asset('custom/theme21/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg')); ?>"
    ...
    <script src="<?php echo e(asset('custom/theme21/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme21/js/slick.min.js')); ?>" defer="defer"></script>

    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme21/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme21/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
    ...
    <script>
        ...
        var is_empty_description = "<?php echo e($is_empty_description); ?>";
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme21/index.blade.php ENDPATH**/ ?>