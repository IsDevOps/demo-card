                    ...
                    <div class="col-lg-2 col-2">
                        <div class="card">
                            <div class="card-body" style="min-height: 230px;">
                                ...
                                <h6 class="mb-0 mt-2"><?php echo e(__('PAID USERS')); ?> : <span class="text-success text-sm "><?php echo e($user['total_paid_user']); ?></span></h6>                    
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-2">
                        <div class="card">
                            <div class="card-body" style="min-height: 230px;">
                                ...
                                <h6 class="mb-0 mt-2"><?php echo e(__('Total Order Amount')); ?> : <span class="text-warning text-sm "><?php echo e($user['total_orders_price']); ?></span></h6>                    
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-2">
                        <div class="card">
                            <div class="card-body" style="min-height: 230px;">
                                ...
                                <h6 class="mb-0 mt-2"><?php echo e(__('Most Purchase Plan')); ?> : <span class="text-primary text-sm "><?php echo e($user['most_purchese_plan']); ?></span></h6>                    
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/dashboard/admin_dashboard.blade.php ENDPATH**/ ?>