...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('NFC History')); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('NFC History')); ?></li>
<?php $__env->stopSection(); ?>
                    ...
                    <table class="table" id="pc-dt-simple">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo e($userlogs->country); ?></td>
                                <td><?php echo e($userlogs->platform); ?></td>
                                <td><?php echo e($userlogs->browser); ?></td>
                                <td><?php echo e($userlogs->created_at); ?></td>
                                <td>
                                    <div class="action-btn bg-secondary ms-2">
                                        <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center " data-url="<?php echo e(route('userlogs.show',$userlogs->id)); ?>" data-size="lg" data-ajax-popup="true"  data-title="<?php echo e(__('View UserLog')); ?>" title="<?php echo e(__('View')); ?>" data-bs-toggle="tooltip" data-bs-placement="top"><span class="text-white"><i class="ti ti-eye text-white"></i></span></a>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/tap_history/index.blade.php ENDPATH**/ ?>