<?php echo e(Form::model($Contacts, array('route' => array('Contacts.update', $Contacts->id)))); ?>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <?php echo e(Form::number('phone',null,array('class'=>'form-control','required'=>'required'))); ?>

    </div>
    <div class="form-group col-md-12">
        <?php echo e(Form::label('message',__('Message'),['class'=>'form-label'])); ?>

        <?php echo e(Form::text('message',null,array('class'=>'form-control','required'=>'required'))); ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/leadcontact/edit.blade.php ENDPATH**/ ?>