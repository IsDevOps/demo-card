...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme4'][$business->theme_color]['theme_name'] }}"
                                            ...
                                            @if (!is_null($contactinfo_content) && !is_null($contactinfo))
                                                @foreach ($contactinfo_content as $key => $val)
                                                    @foreach ($val as $key1 => $val1)
                                                        ...
                                                        @endif
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}" style="border: 1px solid var(--second-color);justify-content: space-evenly;border-radius: 25px;padding: 15px;margin-top:20px">
                                                                @if ($key1 == 'Address')
                                ...
                                <div class="container">
                                    ...
                                    <div class="more-btn">
                                        ...
                                        @foreach ($leadGeneration_content  as $leadgen) 
											...
											<a href="javascript:;" class="btn make-contact-modal-toggle{{$leadgen->id}}" tabindex="0" style="width:100%; margin-top: 15px; border-radius: 25px;height: 60px;border: 1px solid grey;">
        ...
        <a href="{{ route('bussiness.save', $business->slug) }}" class="btn add-to-contact-btn add-to-contact-botton" style="font-size: 16px"><i class="fa fa-address-card"></i>&nbsp; Add to Contact</a>
    </div>
        <!-- appointment popup -->
            ...
            if (name == "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        show_toastr('Success', "{{ __('Details Sent Successfully.') }}",
                            'success');
