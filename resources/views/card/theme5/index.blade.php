...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('custom/theme5/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/theme5/fonts/stylesheet.css') }}">
    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('custom/theme5/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme5/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('custom/theme5/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme5/css/responsive.css') }}">
    @endif
    @if (isset($is_slug))
...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme5'][$business->theme_color]['theme_name'] }}"
        id="view_theme15">
        <main id="boxes">
                        ...
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    <div class="user-name">
                                        <h2 class="text-white" id="{{ $stringid . '_title' }}_preview">
                                            {{ $business->title }}</h2>
                                        <p id="{{ $stringid . '_designation' }}_preview"><b>
                                                {{ $business->designation }}</b></p>
                                ...
                                <div class="text-left desc-wrapper">
                                    <p class="text-white" id="{{ $stringid . '_desc' }}_preview">
                            ...
                            @if ($j == $order_value)
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li id="socials_{{ $loop->parent->index + 1 }}">
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('custom/theme5/icon/social/' . strtolower($social_key1) . '.svg') }}"
                                ...
                                @if ($order_key == 'appointment')
                                    <section class="make-appointment" id="appointment-div">
                                        <div class="section-title text-center">
                                            <h2 class="text-white">{{ __('Make') }} <br>
                                                {{ __('an appointment') }}</h2>
                                        </div>
                                        <div class="appointment-form">
                                            ...
                                            <div class="text-center">
                                                <button
                                                    class="btn hover-secondary appointment-modal-toggle">{{ __('Make an appointment') }}
                                                </button>
                                            </div>
                                        </div>
                                    </section>
                                            ...
                                            @if (!is_null($contactinfo_content) && !is_null($contactinfo))
                                                @foreach ($contactinfo_content as $key => $val)
                                                    @foreach ($val as $key1 => $val1)
                                                        ...
                                                        @endif
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}" style="border: 1px solid #a79483;border-radius: 25px;padding: 10px;margin-top:10px">
                                                                @if ($key1 == 'Address')
                                ...
                                @if ($order_key == 'more')
                                    <section class="more-info" style="padding: 15px; padding-bottom:75px">
                                        ...
                                        <ul class="btn-list">
											...
											<a href="javascript:;" class="btn mt-10 make-contact-modal-toggle{{$leadgen->id}}" tabindex="0" style="margin-top: 12px">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">{{ __('Enter Contact Details') }}</h5>
                    </div>
                    <form action="">
                        <div class="modal-body">
                            <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <form action="">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>{{ __('Message:') }}</label>
                                <textarea name="message{{$leadgen->id}}" class="contact_message{{$leadgen->id}}" cols="30" rows="5"></textarea>
                                <span class="text-white h6 span-error-contactmessage"></span>
                            </div>
                        </div>
                        <div class="modal-footer" style="flex-direction: column;">
                            <button class="btn-secondary make-contact-modal-toggle{{$leadgen->id}}"
                                type="button" style="display:none">{{ __('Close') }}</button>
        ...
        <a href="{{ route('bussiness.save', $business->slug) }}" class="btn btn-primary add-to-contact-btn add-to-contact-botton" style="padding: 20px 47px"><i class="fa fa-address-card"></i>&nbsp; Add <span style="text-transform:lowercase; margin: 0 3px;"> to </span> Contact</a>
    </div>
        {{-- Password modal --}}
    ...
    <script src="{{ asset('custom/theme5/js/jquery.min.js') }}"></script>
    <script src="{{ asset('custom/theme5/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('custom/theme5/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('custom/theme5/js/custom.js') }}" defer="defer"></script>
    @endif
