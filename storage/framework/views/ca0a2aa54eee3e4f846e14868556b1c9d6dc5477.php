...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Edit Business Card')); ?>
                        ...
                        <li class="dropdown dash-h-item drp-language">
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end page-inner-dropdowm">
                                <?php $__currentLoopData = $businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $businessData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('business.edit', $key)); ?>" class="dropdown-item">
                                        <i
                                            class="<?php if($bussiness_id == $key): ?> ti ti-checks text-primary <?php elseif($currantBusiness == $businessData): ?> ti ti-checks text-primary <?php endif; ?> "></i>
                                        <span><?php echo e(ucfirst($businessData)); ?></span>
                                    </a>
						...
						<div class="dropdown-menu dropdown-menu-end">
									...
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('calendar appointment')): ?>
										<a href="<?php echo e(route('appointment.calendar', $business->id)); ?>"
                                            ...
                                            <span class="ml-2"> <?php echo e(__('My Calendar')); ?></span>
                                        </a>
									<?php endif; ?>
									...
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('calendar appointment')): ?>
										<a href="#"
                                            ...
                                            <span class="ml-2"> <?php echo e(__('Download QR Code')); ?></span>
                                        </a>
									<?php endif; ?>
									
										<a href="<?php echo e(url('/' . $business->slug)); ?>" target="-blank" 
                                            class="dropdown-item user-drop">
                                            <i class="fa fa-eye"></i>
									...
									<a href="#"
                                            class="dropdown-item user-drop cp_link" data-link="<?php echo e(url('/' . $business->slug)); ?>" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Click to copy card link')); ?>">
										...
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete business')): ?>
											<a href="#" class="bs-pass-para dropdown-item user-drop"  data-confirm="<?php echo e(__('Delete Business Card?')); ?>" data-text="<?php echo e(__('This action will delete this business card permanently. Continue?')); ?>" data-confirm-yes="delete-form-<?php echo e($business->id); ?>" title="<?php echo e(__('Delete')); ?>" data-bs-toggle="tooltip" data-bs-placement="top"><i class="ti ti-trash"></i><span class="ml-2"><?php echo e(__('Delete')); ?></span></a>
                                ...
                                <div class="col-lg-10 col-md-10">
                                    <div class="theme-detail-card card">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4 ">
                                            <h5 class="mb-0"><?php echo e(__('Edit Personal Data:')); ?></h5>
                                            <button type="submit" class="btn btn-primary d-none"> <i class="me-2"
                                                    data-feather="folder"></i> <?php echo e(__('Update Card')); ?></button>
                                        </div>
                                        <div class="theme-detail-body">
                                            <div class="row mb-4">
                                                <div class="col-lg-8">
                                                    <p class="mb-2"><?php echo e(__('Banner Image:')); ?></p>
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        <label for="file-1">
                                                                            <button type="button" 
                                                                                ...
                                                                                class="me-2" data-feather="upload"></i><?php echo e(__('Upload Banner...')); ?></button>
                                                                        </label>
                                                                    ...
                                                                    <input class="d-none business_logo" type="file"
                                                                        ...
                                                                        <label for="file-2">
                                                                            <button type="button" 
                                                                                ...
                                                                                class="me-2" data-feather="upload"></i><?php echo e(__('Upload Picture')); ?></button>
                                                                        </label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::text('title', $business->title, ['class' => 'form-control emojiarea', 'id' => $stringid . '_title', 'placeholder' => __('Enter Title')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::text('sub_title', $business->sub_title, ['class' => 'form-control emojiarea', 'id' => $stringid . '_subtitle', 'placeholder' => __('Enter Sub Title' ), 'readonly'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" readonly
                                                                ...
                                                                placeholder="https://firstbank.com/james-donald">
											...
											<div class="form-group" >
                                                            <label class="form-label mb-3" style="font-size: 16px"><?php echo e(__('Secret Code')); ?></label>
                                                            <div class="row gy-2">
                                                                <div class="col-xl-9 col-lg-9 col-md-9">
                                                                    <input type="text" name = "reset_code" class="form-control d-inline-block" id="myCode"
                                                                        value="<?php echo e($business->secret_code); ?>" readonly/>
																	
                                                                </div>
                                                                <div class="col-xl-3 col-lg-3 col-md-3">
                                                                    <button type="button" class="btn btn-primary w-100" data-bs-toggle="tooltip" data-bs-placement="bottom"   data-bs-original-title="<?php echo e(__('Reset Code')); ?>" title="<?php echo e(__('Reset Code')); ?>" onclick="dealCode()" style="padding: 0.5rem;"><i
														...
														<div class="accordion-item">
                                                            <h2 class="accordion-header" id="headingThreea">
                                                                <button class="accordion-button collapsed"
                                                                    ...
                                                                    <span
                                                                        class="d-flex align-items-center"><?php echo e(__('Lead Generation')); ?></span>
                                                                    <div class="d-flex align-items-center"
                                                                        data-value="<?php echo e(json_encode($leadGeneration_content)); ?>">
                                                                        <span class="me-2"><?php echo e(__('On/Off:')); ?></span>
                                                                        <div
                                                                            class="form-check form-switch custom-switch-v1">
                                                                            <input type="hidden"
                                                                            ...
                                                                            <input type="checkbox"
                                                                                ...
                                                                                <?php echo e(isset($leadGeneration['is_enabled']) && $leadGeneration['is_enabled'] == '1' ? 'checked="checked"' : ''); ?>>
                                                                        ...
                                                                        <div class="row align-items-center gy-4">
                                                                            <div class="col-lg-12">
                                                                                <div class="bussiness-hours-header">
                                                                                    <div class="row">
                                                                                        <div class="col-lg-5">
                                                                                            <span><?php echo e(__('Lead Title')); ?></span>
                                                                                        </div>
                                                                                        <div class="col-lg-5">
                                                                                            <span><?php echo e(__('End Time')); ?></span>
                                                                                        </div>
                                                                            ...
                                                                            <div id="inputrow_leadgeneration">
                                                                                ...
                                                                                <?php if(!is_null($leadGeneration_content)): ?>
                                                                                    <?php $__currentLoopData = $leadGeneration_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $leadtitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        ...
                                                                                        <div class="row mb-4 inputFormRow5"
                                                                                            ...
                                                                                            <div class="col-lg-5">
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        name="<?php echo e('leadtitle[' . $leadgeneration_no . '][title]'); ?>"
                                                                                                        class="form-control "
                                                                                                        id="leadgeneration_title_<?php echo e($leadgeneration_no); ?>"
                                                                                                        placeholder="FirstBank Expo"
                                                                                                        value="<?php echo e($leadtitle->title); ?>"
                                                                                                        />
                                                                                                </div>
                                                                                            </div>
																							...
																							<div class="col-lg-5">
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        name="<?php echo e('leadtitle[' . $leadgeneration_no . '][btitle]'); ?>"
                                                                                                        class="form-control appointment_time "
                                                                                                        id="leadgeneration_btitle_<?php echo e($leadgeneration_no); ?>"
                                                                                                        placeholder="Button Title"
                                                                                                        value="<?php echo e($leadtitle->btitle); ?>"
                                                                                                        onchange="changeTime(this.id)">
																							...
																							<div class="col-lg-5 d-none">
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        name="<?php echo e('leadtitle[' . $leadgeneration_no . '][created_at]'); ?>"
                                                                                                        class="form-control appointment_time "
                                                                                                        id="leadgeneration_created_at_<?php echo e($leadgeneration_no); ?>"
                                                                                                        placeholder="Created_at"
                                                                                                        value="<?php echo e($leadtitle->created_at); ?>"
                                                                                                        onchange="changeTime(this.id)">
                                                                                            ...
                                                                                            <div class="col-lg-2">
                                                                                                <a href="javascript:void(0);"
                                                                                                    ...
                                                                                                    data-id="<?php echo e('leadgeneration_' . $leadgeneration_no); ?>"><svg
                                                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                                                        width="25"
                                                                                                        height="25"
                                                                                                        viewBox="0 0 25 25"
                                                                            ...
                                                                            <div class="col-12">
                                                                                ...
                                                                                <a href="javascript:void(0)" class="add-new-app flex-row" onclick="leadgenerationRepeater()">
                                                                                    ...
                                                                                    <h6 class="mb-0 ms-2"><?php echo e(__('Add New Lead Generation')); ?></h6>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="accordion-body ">
                                                                    <div class="showGallery">
                                                                        ...
                                                                        <div class="upload-file-div video d-none">
                                                                            ...
                                                                            <div class="choose-file">
                                                                                <input class="custom-input-file custom-input-file-link  upload_video d-none" onchange="showvideoname()" type="file" name="upload_video" id="file-6" multiple="">
                                                                                <label for="file-6">
                                                                                        ...
                                                                                        <?php if(isset($gallery_content->type)): ?>
                                                                                            <?php if($gallery_content->type=='video'): ?>
                                                                                                ...
                                                                                                <div class="col-md-2 col-12">
                                                                                                    <span class=icon>
                                                                                                        <a href="javascript:void(0)" class="close-btn remove_gallery" id="" data-id="<?php echo e($gallery_row_no); ?>">
                                        ...
                                        <div class="text-end mt-4">
                                            <button type="submit" class="btn btn-primary"> <i class="me-2"
                                                    data-feather="credit-card"></i> <?php echo e(__('Update Card')); ?>
                                        ...
                                        <div class="theme-detail-card" style="box-shadow: 0 6px 30px rgba(182, 186, 203, 0.3); background: #ffffff">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-3 ">
                                                ...
                                                <button type="submit" class="btn btn-primary"> <i
                                                        data-feather="grid"></i>&nbsp;<?php echo e(__('Update QR Code')); ?> </button>
                                            </div>
                                        </div>
                                    <?php echo e(Form::close()); ?>
                                ...
                                <div class="col-lg-10 col-md-10">
                                    ...
                                    <div class="select-theme-portion" style="box-shadow: 0 6px 30px rgba(182, 186, 203, 0.3); background: #ffffff;">
										...
										<div class="d-flex align-items-center justify-content-between mb-4 ">
                                            ...
                                            <button type="submit" class="btn btn-primary"> <i class="me-2"
                                                    data-feather="folder"></i> <?php echo e(__('Save Theme')); ?></button>
                                        </div>
                            ...
                            <div class="row gy-4">
                                ...
                                <div <div class="col-lg-10 col-md-10">>
                                    <div class="theme-detail-card" style="box-shadow: 0 6px 30px rgba(182, 186, 203, 0.3); background: #ffffff;">
                                            <div class="d-flex align-items-center justify-content-between mb-4 ">
                                                    <h5 class="mb-0"><?php echo e(__('Re-Order Links')); ?></h5>
                                            ...
                                            <?php for($i = 1; $i <= 11; $i++): ?>
                                                <?php $__currentLoopData = $card_theme->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <li class="list-group-item d-flex align-items-center justify-content-between <?php echo e($card_theme->theme == 'theme5' && $order_key == 'social' ? 'd-none' : ''); ?><?php echo e($card_theme->theme == 'theme6' && $order_key == 'social' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme2' && $order_key == 'description' ? 'd-none' : ''); ?><?php echo e($card_theme->theme == 'theme3' && $order_key == 'description' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme4' && $order_key == 'description' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme5' && $order_key == 'description' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme6' && $order_key == 'description' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme7' && $order_key == 'description' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme8' && $order_key == 'description' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme9' && $order_key == 'description' ? 'd-none' : ''); ?> <?php echo e($card_theme->theme == 'theme10' && $order_key == 'description' ? 'd-none' : ''); ?><?php echo e($card_theme->theme == 'theme11' && $order_key == 'description' ? 'd-none' : ''); ?><?php echo e($card_theme->theme == 'theme9' && $order_key == 'contact_info' ? 'd-none' : ''); ?><?php echo e($card_theme->theme == 'theme4' && $order_key == 'gallery' ? 'd-none' : ''); ?><?php echo e($card_theme->theme == 'theme11' && $order_key == 'contact_info' ? 'd-none' : ''); ?>"
															...
															<?php elseif($order_key == 'leadgeneration'): ?>
                                                                <h6 class="mb-0">
                                                                    <i class="me-3" data-feather="move"></i>
                                                                    <span><?php echo e(__('Lead Generation')); ?></span>
                                                                </h6>
										...
										<div class="text-end mt-4">
                                            <button type="submit" class="btn btn-primary"> <i class="me-2"
                                                    data-feather="link-2" id="btnSubmit"></i> &nbsp;<?php echo e(__('Update Links')); ?>

                                            </button>
                                        </div>
										

                                        <p class="mt-3"><b><?php echo e(__('')); ?></b></p>
                                    </div>
                                </div>
                                <?php echo e(Form::close()); ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="google_fonts">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4 ">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pixel settings business')): ?>
                                                ...
                                                data-bs-placement="top" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Create Pixel')); ?>">
                                                    <a href="#" class="btn btn-sm btn-primary btn-icon m-1 me-2" data-bs-target="#exampleModal"
                        ...
                        <div class="tab-pane fade <?php if(session('tab') and session('tab') == 6): ?> show active <?php endif; ?>" id="pwa-setting" role="tabpanel" aria-labelledby="pills-user-tab-4">
                            <div class="row">
                                <div class="col-12">
                                    <div class="theme-detail-card">
                        ...
                        <div class="tab-pane fade <?php if(session('tab') and session('tab') == 7): ?> show active <?php endif; ?>" id="cookie-setting" role="tabpanel" aria-labelledby="pills-user-tab-4">
                            <div class="row">
                                <div class="col-12">
                                    <div class="theme-detail-card">
...
<?php $__env->startPush('custom-scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var leadgeneration_no = <?php echo e($leadgeneration_no); ?>;
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    function generate_qr() {
        ...
        var card_url = '<?php echo e(env('APP_URL').'/'.$business->slug. '?cxz='.$business->secret_code); ?>';
        $('.code').empty().qrcode({
            render: 'image',
            size: 500,
            ecLevel: 'H',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/business/edit.blade.php ENDPATH**/ ?>