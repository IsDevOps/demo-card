...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme8/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme8/fonts/stylesheet.css')); ?>">

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme8/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme8/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme8/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme8/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme8'][$business->theme_color]['theme_name']); ?>"
        id="view_theme18">
        <main id="boxes">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-name">
                                        ...
                                        <p id="<?php echo e($stringid . '_designation'); ?>_preview"><?php echo e($business->designation); ?>
                            ...
                            <?php if($j == $order_value): ?>
                                                        ...
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <a href="<?php echo e($social_links); ?>" target="_blank"
                                                                    ...
                                                                    <img src="<?php echo e(asset('custom/theme8/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
                                ...
                                <?php if($order_key == 'gallery'): ?>
                                    <section class="gallery-section">
                                        <div class="section-title text-center" id="gallery-div">
                                ...
                                <?php if($order_key == 'contact_info'): ?>
                                    <section class="contact-section" id="contact-div">
                                        <h2 class="text-white"><?php echo e(__('Contact')); ?></h2>
                                                            ...
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                <?php if($key1 == 'Address'): ?>
                                                                    ...
                                                                    <a href="<?php echo e($href); ?>">
                                                                        <span>
                                                                            <img src="<?php echo e(asset('custom/theme8/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($key2 == 'Address'): ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="social-list modal-share">
                            <li>
                                <a href="https://facebook.com" class="fb-icon">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/" class="inkdin-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55"
                                        viewBox="0 0 55 55" fill="none">
    ...
    <script src="<?php echo e(asset('custom/theme8/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme8/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme8/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme8/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme8/index.blade.php ENDPATH**/ ?>