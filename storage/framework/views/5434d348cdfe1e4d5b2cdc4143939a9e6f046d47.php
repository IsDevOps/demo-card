...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme19/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme19/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />
    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme19/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme19/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme19/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme19/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme19/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    ...
    <div id="boxes">
        <div id="view_css"
            class="<?php echo e(\App\Models\Utility::themeOne()['theme19'][$business->theme_color]['theme_name']); ?>">
            <div class="home-wrapper">
                ...
                <section class="top-social-section">
                            ...
                            <?php if(!is_null($contactinfo_content) && !is_null($contactinfo)): ?>
                                <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($key1 != 'id'): ?>
                                            <?php
                                                $svg_file = file_get_contents(asset('custom/theme19/icon/' . $color . '/contact/' . strtolower($key1) . '.svg'));
                                            ...
                                            ?>
                                            <li id="contact1_<?php echo e($loop->parent->index + 1); ?>">
                                                <?php if($key1 == 'Address'): ?>
                                                    ...
                                                    <a href="<?php echo e($href); ?>" target="_blank">
                                                        ...
                                                        <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($key2 == 'Address'): ?>
                                                                <span
                                                                    id="<?php echo e($key1 . '_' . $no); ?>_preview"><?php echo e($key1); ?></span>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(!is_null($contactinfo_content) && !is_null($contactinfo)): ?>
            <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="calllink contactlink contact_<?php echo e($loop->parent->index + 1); ?>"
                                                        id="contact_<?php echo e($loop->parent->index + 1); ?>" style="display: flex">
                                                        <a href="<?php echo e($href); ?>" class="theme-text">
                                                            <?php echo $svg_file_new_2; ?>
                                                            ...
                                                            <div class="contact-text">
                                                                <?php if($key1 == 'Address'): ?>
                                                                    <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($key2 == 'Address'): ?>
                                                                            <?php $href = $val2; ?>
																		<span class="<?php echo e($key1 . '_' . $no); ?>" id="<?php echo e($key1 . '_' . $no); ?>"><?php echo e($val2); ?></span>
                                                                <div class="contact-label"><?php echo e($key1); ?></div>
																	</div>
																	<?php endif; ?>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																...
																<?php else: ?>
                                                                    <?php if($key1 == 'Whatsapp'): ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                            <a href="<?php echo e($href); ?>" style="justify-content: space-between;margin-top: 0">
																		
                                                                    <?php endif; ?>
                                                                    <div class="contact-text">
																																											<span class="<?php echo e($key1 . '_' . $no); ?>" id="<?php echo e($key1 . '_' . $no); ?>"><?php echo e($val1); ?></span>
                                                                <div class="contact-label"><?php echo e($key1); ?></div>
																	</div>
															</div>
                                                    ...
                                                    <?php if($social_key1 != 'id'): ?>
                                                        <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                            ...
                                                            <a href="<?php echo e($social_links); ?>"
                                                                ...
                                                                <img src="<?php echo e(asset('custom/theme19/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg')); ?>"
    ...
    <script src="<?php echo e(asset('custom/theme19/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme19/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme19/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme19/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme19/index.blade.php ENDPATH**/ ?>