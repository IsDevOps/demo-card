...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme20/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme20/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />

    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme20/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme20/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme20/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme20/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme20/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme20'][$business->theme_color]['theme_name']); ?>"
            id=view_theme9>
            <div class="home-wrapper">
                <section class="client-info-section padding-top">
                    <div class="container">
                        ...
                        <p class="client-text" id="<?php echo e($stringid . '_desc'); ?>_preview"><?php echo e($business->description); ?></p>
                    </div>
                </section>
                <?php $j = 1; ?>
                <?php $__currentLoopData = $card_theme->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($j == $order_value): ?>
                        ...
                        <?php if($order_key == 'scan_me'): ?>
                            <section class="scanner-section padding-top">
                                <div class="container">
                                    <div class="scanner-wrapper">
                                        <div class="scanner-info">
                                            <h2><?php echo e(__('Scan Me')); ?></h2>
                                        ...
                                        <div class="scanner-image-inner">
                                            <div class="scan-img">
                                                <div class="shareqrcode2"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php if($order_key == 'appointment'): ?>
                            <section class="appointment-section padding-top padding-bottom" id="appointment-div">
                                <div class="container">
                                    <div class="section-title">
                                        <h2><?php echo e(__('Make an')); ?> <?php echo e(__(' appointment')); ?></h2>
                                    </div>
                                    <form class="appointment-detail">
                                        ...
                                        <div class="app-hour form-group" id="inputrow_appointment_preview">
                                            ...
                                            <select class="form-control app_select time">
                                                <option id=""><?php echo e(__('Select hour')); ?></option>
                                                <?php if(!is_null($appoinment_hours)): ?>
                                                    <?php $__currentLoopData = $appoinment_hours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $hour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option id="<?php echo e('appointment_' . $appointment_no); ?>">
                                                            <span id="appoinment_start_<?php echo e($appointment_no); ?>_preview">
                        ...
                        <?php if($order_key == 'contact_info'): ?>
                            <section class="contact-info-section" id="contact-div">
                                <div class="container">
                                    <div class="section-title">
                                        <h2><?php echo e(__('Contact informations')); ?></h2>
                                    </div>
                                    <div class="client-contact">
                                        <div class="calllink contactlink">
                                            <ul class="justify-content-center" id="inputrow_contact_preview">
                                                <?php if(!is_null($contactinfo_content) && !is_null($contactinfo)): ?>
                                                    <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($social_key1 == 'Phone'): ?>
                                                                <?php $href = 'tel:'.$social_val1; ?>
                                                            <?php elseif($social_key1 == 'Email'): ?>
                                                                <?php $href = 'mailto:'.$social_val1; ?>
                                                            <?php elseif($social_key1 == 'Address'): ?>
                                                                <?php $href = ''; ?>
                                                            <?php else: ?>
                                                                <?php $href = $social_val1 ?>
                                                            <?php endif; ?>
                                                                ...
                                                                <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                    <div class="justify-content-start">
                                                                        <div class="contact-label">
                                                                            <span>
                                                                                <?php if($social_key1 == 'Web_url'): ?><?php echo e(__('Web Url')); ?> <?php else: ?><?php echo e(__($social_key1)); ?><?php endif; ?>
                                                                            </span>
                                                                        </div>

                                                                        <?php if($social_key1 == 'Address'): ?>
                                                                            <?php $__currentLoopData = $social_val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <a href="<?php echo e($href); ?>"
                                                                                ...
                                                                                <?php $__currentLoopData = $social_val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <?php if($key2 == 'Address'): ?>
                                                                                        <h4
                                                                                            id="<?php echo e($social_key1 . '_' . $no); ?>_preview">
                                                                                            <?php echo e($val2); ?></h4>
                                                                                    <?php endif; ?>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="testimonial-itm-inner-pdf">
                                                            ...
                                                            <div class="testimonial-pdf-bdy">
                                                                <h5 class="rating-number">
                                                                    <?php echo e($testi_content->rating); ?>/5</h5>
                                                                ...
                                                                <div class="rating-star">
                                                                    ...
                                                                    ?>
                                                                    <span
                                                                        id="<?php echo e('stars' . $testimonials_row_no); ?>_star"
                        ...
                        <?php if($order_key == 'social'): ?>
                            <section class="social-icons-section" id="social-div">
                                <div class="container">
                                    <ul class="social-icon-wrapper inputrow_socials_preview">
                                        <?php if(!is_null($social_content) && !is_null($sociallinks)): ?>
                                            <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($social_key1 != 'id'): ?>
                                                        <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                            ...
                                                            <div>
                                                                <a href="<?php echo e($social_links); ?>"
                                                                    ...
                                                                    target="_blank">
                                                                    <img src="<?php echo e(asset('custom/theme20/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
                                                                        alt="<?php echo e($social_key1); ?>"
                                                                        class="img-fluid theme-svg">
                                                                </a>
                                                            </div>
                                                        </li>
                                                    <?php endif; ?>
                        ...
                        <div class="qr-scaner-wrapper">
                            ...
                            <div class="qr-code-text">
                                <p><?php echo e(__('Point your camera at the QR code, or visit ')); ?><span
                                        class="qr-link text-center mr-2 text-wrap"></span><br><?php echo e(__('Or check my social channels')); ?>
                                    ...
                                    <a href="https://twitter.com">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <rect x="0.75" y="0.75" width="18.5" height="18.5"
                                                rx="3.25" stroke="black" stroke-width="1.5"></rect>
                                        </svg>
                                    </a>
                                </li>
                                <li>
    ...
    <script src="<?php echo e(asset('custom/theme20/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme20/js/slick.min.js')); ?>" defer="defer"></script>

    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme20/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme20/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme20/index.blade.php ENDPATH**/ ?>