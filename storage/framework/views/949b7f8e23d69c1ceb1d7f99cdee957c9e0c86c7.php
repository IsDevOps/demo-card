...
<form action="" id="myForm">
    ...
    <div class="response">
        <a class="btn btn-primary btn-sm float-left" href="#!" id="generate1"><?php echo e(__('Generate')); ?></a>
...
<script>
    function copyText() {
        var business_id="<?php echo e($business_id); ?>";
    ...
    $('body').on('click', '#generate1', function() {
        var form = $("#myForm");
        $.ajax({
            type: 'post',
            ...
            beforeSend: function(msg) {
                ...
                $("#generate1").append(html);
            },
            afterSend: function(msg) {
                $("#generate2").empty();
                var html =
                    `<a class="btn btn-primary" href="#!" id="generate1"><?php echo e(__('Generate')); ?></a>`;
                $("#generate2").replaceWith(html);

            },
            success: function(data){
                $('.response').removeClass('d-none');
                $('#generate1').text('Re-Generate');
                if(data.message){
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/generate_business.blade.php ENDPATH**/ ?>