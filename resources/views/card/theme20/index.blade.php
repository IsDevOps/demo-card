...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('custom/theme20/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/theme20/fonts/stylesheet.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/plugins/animate.min.css') }}" />

    @if (isset($is_slug))
        <link rel="stylesheet" href="{{ asset('custom/theme20/modal/bootstrap.min.css') }}">
    @endif

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('custom/theme20/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme20/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('custom/theme20/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme20/css/responsive.css') }}">
    @endif
...
<body class="tech-card-body">
            ...
            <div class="home-wrapper">
                <section class="client-info-section padding-top">
                    <div class="container">
                        ...
                        <p class="client-text" id="{{ $stringid . '_desc' }}_preview">{{ $business->description }}</p>
                    </div>
                </section>
                @php $j = 1; @endphp
                                                    ...
                                                    @foreach ($contactinfo_content as $social_key => $social_val)
                                                        @foreach ($social_val as $social_key1 => $social_val1)
                                                            ...
                                                            @elseif($social_key1 == 'Email')
                                                                @php $href = 'mailto:'.$social_val1; @endphp
                                                            @elseif($social_key1 == 'Address')
                                                                @php $href = ''; @endphp
                                                            @else
                                                                ...
                                                                <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                    <div class="justify-content-start">
                                                                        <div class="contact-label">
                                                                            <span>
                                                                                @if($social_key1 == 'Web_url'){{ __('Web Url') }} @else{{ __($social_key1) }}@endif
                                                                            </span>
                                                                        </div>

                                                                        @if ($social_key1 == 'Address')
                                                                            @foreach ($social_val1 as $key2 => $val2)
                                                                                @if ($key2 == 'Address_url')
                                                        ...
                                                        <li class="socials_{{ $loop->parent->index + 1 }}"
                                                            ...
                                                            <div>
                                                                <a href="{{ $social_links }}"
                                                                    ...
                                                                    target="_blank">
                                                                    <img src="{{ asset('custom/theme20/icon/social/' . strtolower($social_key1) . '.svg') }}"
                                                                        alt="{{ $social_key1 }}"
    ...
    <script src="{{ asset('custom/theme20/js/jquery.min.js') }}"></script>
    <script src="{{ asset('custom/theme20/js/slick.min.js') }}" defer="defer"></script>

    @if ($SITE_RTL == 'on')
        <script src="{{ asset('custom/theme20/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('custom/theme20/js/custom.js') }}" defer="defer"></script>
    @endif
