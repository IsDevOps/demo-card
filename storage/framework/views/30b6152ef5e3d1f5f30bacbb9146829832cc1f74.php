...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme17/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme17/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />

    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme17/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme17/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme17/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme17/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme17/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme17'][$business->theme_color]['theme_name']); ?>"
            id="view_theme6">
                                        ...
                                        <div class="daily-hours-inner">
                                            <ul class="pl-1">
                                                <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="<?php echo e($day == 'Sunday' ? 'day-closed' : ''); ?>">
                                                            ...
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <div>
                                                                    <a href="<?php echo e($social_links); ?>"
                                                                        ...
                                                                        target="_blank">
                                                                        <img src="<?php echo e(asset('custom/theme17/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg')); ?>"
    ...
    <script src="<?php echo e(asset('custom/theme17/js/jquery.min.js')); ?>"></script>

    <script src="<?php echo e(asset('custom/theme17/js/slick.min.js')); ?>" defer="defer"></script>

    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme17/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme17/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme17/index.blade.php ENDPATH**/ ?>