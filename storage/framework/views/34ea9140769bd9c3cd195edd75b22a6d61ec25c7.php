                    ...
                    <div class="auth-footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    <p class="">
                                        <?php echo e(__('Copyright © ')); ?><?php echo e(isset($langSetting['footer_text']) ? $langSetting['footer_text'] : config('app.name', 'versecards')); ?> <?php echo e(date('Y')); ?> </p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/layouts/auth.blade.php ENDPATH**/ ?>