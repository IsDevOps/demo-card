                                ...
                                <div class="container">
                                    ...
                                    <div class="more-btn">
                                        ...
                                        @foreach ($leadGeneration_content  as $leadgen) 
											...
											<a href="javascript:;" class="btn lead-generation{{$leadgen->id}}" tabindex="0">
												<img src="{{ asset('custom/theme12/icon/' . $color . '/phone.svg') }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name{{$leadgen->id}}" placeholder="{{ __('Enter your name') }}"
										...
										<input type="text" name="campaign_id{{$leadgen->id}}" class="form-control campaign_id{{$leadgen->id}}" value = "{{$leadgen->id}}">
                                    <div class="">
