...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('custom/theme18/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/theme18/fonts/stylesheet.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/plugins/animate.min.css') }}" />

    @if (isset($is_slug))
        <link rel="stylesheet" href="{{ asset('custom/theme18/modal/bootstrap.min.css') }}">
    @endif

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('custom/theme18/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme18/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('custom/theme18/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme18/css/responsive.css') }}">
    @endif
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme18'][$business->theme_color]['theme_name'] }}"
            id="view_theme7">
                                        ...
                                        @if (!is_null($contactinfo_content) && !is_null($contactinfo))
                                            @foreach ($contactinfo_content as $key => $val)
                                                @foreach ($val as $key1 => $val1)
                                                    ...
                                                    @endif
                                                    @if ($key1 != 'id')
                                                        <div class="calllink contactlink {{ $count > 1 ? 'linkdinlink contactlink' : '' }}"
                                                            ...
                                                            @if ($key1 == 'Address')
                                                                ...
                                                                <a href="{{ $href }}" target="_blank">
                                                                    ...
                                                                    <div class="contact-svg">
                                                                        <img src="{{ asset('custom/theme18/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                            class="img-fluid">
                                                                    </div>
                                                ...
                                                <div class="testimonial-itm"
                                                    ...
                                                    <div class="testimonial-itm-inner">
                                                        ...
                                                        <h5 class="rating-number">
                                                            <span class="{{ 'stars' . $testimonials_row_no }}">
                                                                {{ $testi_content->rating }}</span>/5
                                                        </h5>
                                                        @php
                                                            if (!empty($testi_content->rating)) {
                                                                $rating = (int) $testi_content->rating;
                                                        ...
                                                        <li class="socials_{{ $loop->parent->index + 1 }}"
                                                            ...
                                                            <div>
                                                                <a href="{{ $social_links }}"
                                                                    ...
                                                                    target="_blank">
                                                                    <img src="{{ asset('custom/theme18/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                                                                        alt="{{ $social_key1 }}"
    ...
    <script src="{{ asset('custom/theme18/js/jquery.min.js') }}"></script>
    <script src="{{ asset('custom/theme18/js/slick.min.js') }}" defer="defer"></script>

    @if ($SITE_RTL == 'on')
        <script src="{{ asset('custom/theme18/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('custom/theme18/js/custom.js') }}" defer="defer"></script>
    @endif
