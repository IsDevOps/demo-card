...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme18/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme18/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />

    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme18/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme18/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme18/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme18/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme18/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme18'][$business->theme_color]['theme_name']); ?>"
            id="view_theme7">
                ...
                <?php $__currentLoopData = $card_theme->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($j == $order_value): ?>
                        <?php if($order_key == 'contact_info'): ?>
                            <section class="contact-info-section box-shadow padding-bottom" id="contact-div">
                                <div class="container">
                                        ...
                                        <?php if(!is_null($contactinfo_content) && !is_null($contactinfo)): ?>
                                            <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if($key1 != 'id'): ?>
                                                        <div class="calllink contactlink <?php echo e($count > 1 ? 'linkdinlink contactlink' : ''); ?>"
                                                            ...
                                                            <?php if($key1 == 'Address'): ?>
                                                                ...
                                                                <a href="<?php echo e($href); ?>" target="_blank">
                                                                    ...
                                                                    <div class="contact-svg">
                                                                        <img src="<?php echo e(asset('custom/theme18/icon/' . $color . '/contact/' . strtolower($key1) . '.svg')); ?>"
                                                                            class="img-fluid">
                                                                    </div>
                        ...
                        <?php if($order_key == 'description'): ?>
                            <section class="more-card-section box-shadow padding-bottom">
                                <div class="container">
                        ...
                        <?php if($order_key == 'appointment'): ?>
                            <section class="appointment-section box-shadow padding-top padding-bottom"
                                id="appointment-div">
                                <div class="container">
                        ...
                        <?php if($order_key == 'testimonials'): ?>
                            <section class="testimonials-section box-shadow padding-top padding-bottom"
                                id="testimonials-div">
                                <div class="container">
                                    <div class="section-title text-center">
                                                ...
                                                <div class="testimonial-itm"
                                                    ...
                                                    <div class="testimonial-itm-inner">
                                                        ...
                                                        <h5 class="rating-number">
                                                            <span class="<?php echo e('stars' . $testimonials_row_no); ?>">
                                                                <?php echo e($testi_content->rating); ?></span>/5
                                                        </h5>
                                                        <?php
                                                            if (!empty($testi_content->rating)) {
                                                                $rating = (int) $testi_content->rating;
                        ...
                        <?php if($order_key == 'bussiness_hour'): ?>
                            <section class="business-hour-section box-shadow padding-top padding-bottom"
                        ...
                        <?php if($order_key == 'service'): ?>
                            <section class="service-section box-shadow padding-top padding-bottom" id="services-div">
                                <div class="container">
                                    <div class="section-title text-center">
                        ...
                        <?php if($order_key == 'gallery'): ?>
                            <section class="gallery-section box-shadow padding-top padding-bottom" id="gallery-div">
                                <div class="container">
                                    <div class="section-title text-center">
                                                        ...
                                                        <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                            ...
                                                            <div>
                                                                <a href="<?php echo e($social_links); ?>"
                                                                    ...
                                                                    target="_blank">
                                                                    <img src="<?php echo e(asset('custom/theme18/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg')); ?>"
                        ...
                        <div class="row appo-form-details">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone" class="form-control app_phone"
                                ...
                                <div class="text">
                                    <p>
                                        <?php echo e(__('Point your camera at the QR code, or visit')); ?> <span
                                            class="qr-link text-center mr-2 text-wrap"></span>
                                    </p>
                                </div>
                                <div class="text">
                                    <p class="mb-0">
                        ...
                        <div class="row appo-form-details">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="message" placeholder="" row="3" class="custom_size contact_message emojiarea con_massage"
    ...
    <script src="<?php echo e(asset('custom/theme18/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme18/js/slick.min.js')); ?>" defer="defer"></script>

    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme18/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme18/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
    ...
    <script>
        ...
        $(`#makecontact`).click(function() {
            ...
            if (name == "") {
                ...
                $(`.span-error-contactmessage`).text("<?php echo e(__('*Please enter your massage.')); ?>");
            } else {
                $(`.span-error-contactname`).text("");
                $(`.span-error-contactemail`).text("");
                $(`.span-error-contactphone`).text("");
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme18/index.blade.php ENDPATH**/ ?>