...
<?php if($chatgpt_setting['enable_chatgpt']=='on'): ?>
    <div class="col-xl-12 col-lg-12 col-md-12 d-flex align-items-center justify-content-between justify-content-md-end"
        ...
        <a href="#" data-size="lg" class="btn btn-sm btn-primary" data-ajax-popup-over="true"
            data-url="<?php echo e(route('generate', ['Add Note on appointment'])); ?>" data-bs-toggle="tooltip"
...
<div class="row">
    ...
    <div class="col-12 form-group mt-4">
        <div class="row gutters-xs">
            ...
            <div class="col-12">
                <textarea class="summernote-simple" id="note" rows="3" name="note"><?php echo $appointment->note; ?></textarea>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/appointments/add_note.blade.php ENDPATH**/ ?>