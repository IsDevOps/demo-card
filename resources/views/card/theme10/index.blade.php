...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('custom/theme10/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/theme10/fonts/stylesheet.css') }}">

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('custom/theme10/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme10/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('custom/theme10/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme10/css/responsive.css') }}">
    @endif
...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme10'][$business->theme_color]['theme_name'] }}"
        id="view_theme20">
        <main id="boxes">
                                ...
                                @if ($order_key == 'appointment')
                                    <section class="make-appointment" id="appointment-div">
                                        <div class="section-title text-center">
                                            <h2 class="text-white">{{ __('Make') }} <br> {{ __('an appointment') }}
                                            </h2>
                                        </div>
                                                        ...
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    <a href="{{ $href }}">
                                                                        <span>
                                                                            <img src="{{ asset('custom/theme10/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        @foreach ($val1 as $key2 => $val2)
                                                                            @if ($key2 == 'Address')
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('custom/theme10/icon/social/' . strtolower($social_key1) . '.svg') }}"
    ...
    <script src="{{ asset('custom/theme10/js/jquery.min.js') }}"></script>
    <script src="{{ asset('custom/theme10/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('custom/theme10/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('custom/theme10/js/custom.js') }}" defer="defer"></script>
    @endif
