...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/fonts/stylesheet.css')); ?>">
    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme3'][$business->theme_color]['theme_name']); ?>"
        id="view_theme13">
        <main id="boxes">
                                                            ...
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                <?php if($key1 == 'Address'): ?>
                                                                    ...
                                                                    <a href="<?php echo e($href); ?>">
                                                                        <span>
                                                                            <img src="<?php echo e(asset('custom/theme3/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($key2 == 'Address'): ?>
                                                        ...
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li id="socials_<?php echo e($loop->parent->index + 1); ?>">
                                                                ...
                                                                <a href="<?php echo e($social_links); ?>" target="_blank"
                                                                    ...
                                                                    <img src="<?php echo e(asset('custom/theme3/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
                    ...
                    <form action="">
                        ...
                        <div class="modal-footer">
                            <button class="btn-secondary appointment-modal-toggle"
                                type="button"><?php echo e(__('Close')); ?>
    ...
    <script src="<?php echo e(asset('custom/theme3/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme3/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme3/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme3/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme3/index.blade.php ENDPATH**/ ?>