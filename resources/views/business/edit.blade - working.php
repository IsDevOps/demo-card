...
@if ($business->status != 'lock')
    <div class="d-flex align-items-center justify-content-end gap-2">
        <a href="#"
                class=" btn btn-sm d-inline-flex bg-success align-items-center cp_link"
        ...
        <a href="{{ route('business.analytics', $business->id) }}"
            class=" btn btn-sm d-inline-flex bg-info  align-items-center"
        ...
        <a href="{{ route('appointment.calendar', $business->id) }}"
            class=" btn btn-sm  bg-warning  d-inline-flex align-items-center"
            data-bs-toggle="tooltip" data-bs-placement="bottom"
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="tab-content" id="pills-tabContent">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    {{ Form::text('title', $business->title, ['class' => 'form-control emojiarea', 'id' => $stringid . '_title', 'placeholder' => __('Enter Title')]) }}
                                                                    @error('title')
                                                                        <span class="invalid-favicon text-xs text-danger"
                                                                            role="alert">{{ $message }}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    {{ Form::text('sub_title', $business->sub_title, ['class' => 'form-control emojiarea', 'id' => $stringid . '_subtitle', 'placeholder' => __('Enter Sub Title' ), 'readonly']) }}
                                                                    @error('sub_title')
                                                                        <span class="invalid-favicon text-xs text-danger"
                                                                            role="alert">{{ $message }}</span>
                                                                    @enderror
                                                                                        ...
                                                                                        @if(isset($gallery_content->type))
                                                                                            @if($gallery_content->type=='video')
                                                                                                ...
                                                                                                <div class="col-md-2 col-12">
                                                                                                    <span class=icon>
                                                                                                        <a href="javascript:void(0)" class="close-btn remove_gallery" id="" data-id="{{$gallery_row_no}}">
                            ...
                            <div class="row gy-4">
                                ...
                                <div <div class="col-lg-10 col-md-10">>
                                    <div class="theme-detail-card">
										...
										<div class="text-end mt-4">
                                            <button type="submit" class="btn btn-primary"> <i class="me-2"
                                                    data-feather="folder" id="btnSubmit"></i> &nbsp;{{__('Update Arrangement')}}
                                            </button>
                                        </div>
                        ...
                        {{-- PWA Tab  --}}
                        <div class="tab-pane fade @if(session('tab') and session('tab') == 6) show active @endif" id="pwa-setting" role="tabpanel" aria-labelledby="pills-user-tab-4">
                            <div class="row">
                                <div class="col-12">
                                    <div class="theme-detail-card">
                        ...
                        {{-- PWA Tab END --}}
                        {{-- Start GDPR Cookies  --}}
                        <div class="tab-pane fade @if(session('tab') and session('tab') == 7) show active @endif" id="cookie-setting" role="tabpanel" aria-labelledby="pills-user-tab-4">
                            <div class="row">
                                <div class="col-12">
                                    <div class="theme-detail-card">
