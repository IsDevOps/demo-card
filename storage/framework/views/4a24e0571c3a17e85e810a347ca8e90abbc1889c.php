...
<div class="page-title">
  <div class="row justify-content-between align-items-center">
    <div class="col-md-6 mb-3 mb-md-0">
      <h5 class="h3 font-weight-400 mb-0"><?php echo e(__('Morning,')); ?> <?php echo e(Auth::user()->name); ?>!</h5>
      <span class="text-sm"><?php echo e(__('Have a nice day!')); ?></span>
    </div>
...
<div class="row">
    <div class="col-xl-3 col-md-6">
      <div class="card card-stats">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col">
              <h6 class="text-muted "><?php echo e(__('Total Business')); ?></h6>
            </div>
            <div class="col-auto">
              <span class="h3 font-weight-bold mb-0 "><?php echo e($total_bussiness); ?></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card card-stats">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col">
              <h6 class="text-muted "><?php echo e(__('Total Appointments')); ?></h6>
            </div>
            <div class="col-auto">
              <span class="h3 font-weight-bold mb-0 "><?php echo e($total_app); ?></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-12 col-md-12">
            <div class="card card-fluid">
                <div class="card-header">
                    <h6 class="mb-0 float-left"><?php echo e(__('Appointments')); ?></h6>
                    <span class="mb-0 float-right"><?php echo e(__('Last 30 Days')); ?></span>
                </div>
    ...
    <div class="row">
       ...
       <div class="col-xl-6 col-md-6 col-sm-12">
           <div class="card card-fluid">
               <div class="card-header">
                   <h6 class="mb-0 float-left"><?php echo e(__('Platform')); ?></h6>
                   <span class="mb-0 float-right"><?php echo e(__('Last 15 Days')); ?></span>
               </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/home.blade.php ENDPATH**/ ?>