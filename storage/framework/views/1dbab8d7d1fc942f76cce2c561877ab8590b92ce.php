        ...
        <div class="col-lg-4">
            <div class="card ">
                ...
                data-bs-whatever="<?php echo e($appointment['title']); ?>" data-bs-toggle="modal" class="btn btn-sm"><i class="ti ti-eye"></i></a> -->
                            ...
                            <?php endif; ?>
                            <input type="hidden" class="business_id" name="business_id" value="<?php echo e($appointment['business_id']); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/appointments/calender.blade.php ENDPATH**/ ?>