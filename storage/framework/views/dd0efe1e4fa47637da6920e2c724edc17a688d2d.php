...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme15/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme15/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />

    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme15/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme15/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme15/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme15/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme15/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme15'][$business->theme_color]['theme_name']); ?>"
            id="view_theme4">
                                ...
                                <div class="container">
                                    <div class="more-card-btn">
                                        <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>" class="btn"
                                            tabindex="0">
                                            <img src="<?php echo e(asset('custom/theme15/icon/' . $color . '/folder.svg')); ?>"
                                        ...
                                        <a href="javascript:;" class="btn our-card" tabindex="0">
                                            <img src="<?php echo e(asset('custom/theme15/icon/' . $color . '/signout.svg')); ?>"
                                                alt="signout" class="img-fluid">
                                            <?php echo e(__('Share Card')); ?>

                                        </a>
                                        <a href="javascript:;" class="btn our-contact" tabindex="0">
                                            <img src="<?php echo e(asset('custom/theme3/icon/' . $color . '/phone.svg')); ?>"
                                                alt="signout" class="img-fluid">
                                                        ...
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <a href="<?php echo e($social_links); ?>" target="_blank">
                                                                    ...
                                                                    <img src="<?php echo e(asset('custom/theme15/icon/social/' . $color . '/' . strtolower($social_key1) . '.svg')); ?>"
                                                            ...
                                                            <?php if($key1 == 'Address'): ?>
                                                                ...
                                                                <a href="<?php echo e($href); ?>" target="_blank">
                                                                    ...
                                                                    <div class="contact-svg">
                                                                        <img src="<?php echo e(asset('custom/theme15/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                            class="img-fluid">
                                                                    </div>
                ...
                <div class="container">
                    <form class="appointment-form-wrapper contact-form-wrapper">
                        ...
                        <div class="section-title">
                            ...
                            <div class="close-search">
                                <img src="<?php echo e(asset('custom/theme15/icon/' . $color . '/close.svg')); ?>"
    ...
    <script src="<?php echo e(asset('custom/theme15/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme15/js/slick.min.js')); ?>" defer="defer"></script>

    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme15/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme15/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme15/index.blade.php ENDPATH**/ ?>