...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme4'][$business->theme_color]['theme_name']); ?>"
            ...
            <div class="card-wrapper">
                <div class="bussiness-card">
                    <div class="bussiness-card-body">
                        <section class="profile-section" style="padding-bottom: 45px">
                        ...
                        <?php $__currentLoopData = $card_theme->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($j == $order_value): ?>
                                        ...
                                        <?php if(isset($is_pdf)): ?>
                                            <div class="row" id="inputrow_service_preview">
                                                ...
                                                <?php $__currentLoopData = $services_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k1 => $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="service-card col-sm-6 col-12"
                                            ...
                                            <?php if(!is_null($contactinfo_content) && !is_null($contactinfo)): ?>
                                                <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if($key1 != 'id'): ?>
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>" style="border: 1px solid var(--second-color);justify-content: space-evenly;border-radius: 25px;padding: 15px;margin-top:20px">
                                                                <?php if($key1 == 'Address'): ?>
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												<li 
                                                                   style="border: 1px solid var(--second-color);justify-content: space-evenly;border-radius: 25px;padding: 15px;margin-top:20px">
																	<a href="javascript:void(0)"
                                                    class="btn make-contact-modal-toggle" style="justify-content: space-between;margin-top: 0">
                                                                        <span>
                                                                            <img src="<?php echo e(asset('custom/theme4/icon/' . $color . '/phone.svg')); ?>"
                                                                                class="img-fluid">
                                                                        </span>
                                                                                    <span>
                                                                                        Exchange Contact
                                ...
                                <?php if($order_key == 'appointment'): ?>
                                    <section class="make-appointment" id="appointment-div">
                                        <div class="section-title text-center">
                                            <h2><?php echo e(__('Book')); ?> <?php echo e(__('Appointment')); ?> </h2>
                                        </div>
                                ...
                                <?php if($order_key == 'social'): ?>
                                    <section class="social" id="social-div">
                                        <div style="border: 1px solid var(--theme-color);margin-top: 40px;padding: 30px;border-radius: 25px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
                            ...
                            <section class="more-card-section padding-bottom" style="padding-top: 20px;">
                                ...
                                <div class="container">
                                    ...
                                    <div class="more-btn">
                                        ...
                                        <?php $__currentLoopData = $leadGeneration_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leadgen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
											...
											<a href="javascript:;" class="btn make-contact-modal-toggle<?php echo e($leadgen->id); ?>" tabindex="0" style="width:100%; margin-top: 15px; border-radius: 25px;height: 60px;border: 1px solid grey;">
        ...
        <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>" class="btn add-to-contact-btn add-to-contact-botton" style="font-size: 16px"><i class="fa fa-address-card"></i>&nbsp; Add to Contact</a>
    </div>
        <!-- appointment popup -->
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name<?php echo e($leadgen->id); ?>" class="contact_name<?php echo e($leadgen->id); ?>"
                                    placeholder="<?php echo e(__('Enter your name')); ?>" style="border-radius:25px">
                                <span class="text-danger  h6 span-error-contactname"></span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email<?php echo e($leadgen->id); ?>" class="contact_email<?php echo e($leadgen->id); ?>"
                                    placeholder="<?php echo e(__('Enter your email')); ?>" style="border-radius:25px">
                                <span class="text-danger  h6 span-error-contactemail"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Phone:')); ?></label>
                                <input type="tel" name="phone<?php echo e($leadgen->id); ?>" class="contact_phone<?php echo e($leadgen->id); ?>"
                                    placeholder="<?php echo e(__('Enter your phone no')); ?>" style="border-radius:25px">
                                <span class="text-danger  h6 span-error-contactphone"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Additional Info:')); ?></label>
                                <textarea name="message<?php echo e($leadgen->id); ?>" class="contact_message<?php echo e($leadgen->id); ?>" cols="30" rows="5" style="border-radius:25px"></textarea>
                                <span class="text-danger  h6 span-error-contactmessage"></span>
                            </div>
                        </div>
                        <div class="modal-footer"style="flex-direction: column;">
                            <button class="btn-secondary d-none make-contact-modal-toggle<?php echo e($leadgen->id); ?>"
                                type="button" style="display:none"><?php echo e(__('Cancel')); ?></button>
            ...
            if (name == "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        show_toastr('Success', "<?php echo e(__('Details Sent Successfully.')); ?>",
                            'success');
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme4/index.blade.php ENDPATH**/ ?>