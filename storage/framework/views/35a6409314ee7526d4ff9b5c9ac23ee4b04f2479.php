...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme6/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme6/fonts/stylesheet.css')); ?>">
    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme6/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme6/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme6/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme6/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme6'][$business->theme_color]['theme_name']); ?>"
        id="view_theme16">
        <main id="boxes">
                                ...
                                <div class="user-profile">
                                    ...
                                    <div class="user-name">
                                        ...
                                        <p id="<?php echo e($stringid . '_designation'); ?>_preview">
                                            <b><?php echo e($business->designation); ?></b>
                                        </p>
                                                            ...
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                <?php if($key1 == 'Address'): ?>
                                                                    ...
                                                                    <a href="<?php echo e($href); ?>">
                                                                        <span>
                                                                            <img src="<?php echo e(asset('custom/theme6/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($key2 == 'Address'): ?>
                                                        ...
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <a href="<?php echo e($social_links); ?>" target="_blank"
                                                                    ...
                                                                    <img src="<?php echo e(asset('custom/theme6/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="contact_name"
                                    placeholder="<?php echo e(__('Enter your name')); ?>">
                                <span class="text-black  h6 span-error-contactname"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Email:')); ?></label>
                                <input type="email" name="email" class="contact_email"
                                    placeholder="<?php echo e(__('Enter your email')); ?>">
                                <span class="text-black  h6 span-error-contactemail"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Phone:')); ?></label>
                                <input type="tel" name="phone" class="contact_phone"
                                    placeholder="<?php echo e(__('Enter your phone no')); ?>">
                                <span class="text-black  h6 span-error-contactphone"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Message:')); ?></label>
                                <textarea name="message" class="contact_message" cols="30" rows="5"></textarea>
                                <span class="text-black  h6 span-error-contactmessage"></span>
                            </div>
                        </div>
                        <div class="modal-footer">
                    ...
                    <form action="">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <span class="text-black h6 span-error-password"></span>
                            </div>
                        </div>
                        <div class="modal-footer">
    ...
    <script src="<?php echo e(asset('custom/theme6/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme6/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme6/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme6/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme6/index.blade.php ENDPATH**/ ?>