...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/fonts/stylesheet.css')); ?>">

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme1'][$business->theme_color]['theme_name']); ?>"
        id="view_theme11">
        <main id="boxes">
                        ...
                        <?php $__currentLoopData = $card_theme->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($j == $order_value): ?>
                                <?php if($order_key == 'description'): ?>
                                    <section class="detail-section" id="description-div">
                                ...
                                <?php if($order_key == 'contact_info'): ?>
                                    <section id="contact-div" id="contact-div">
                                                        ...
                                                        <?php if($key1 != 'id'): ?>
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                <?php if($key1 == 'Address'): ?>
                                                                    ...
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    <span class="icon">
                                                                        <img src="<?php echo e(asset('custom/theme1/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                            class="img-fluid">
                                                                    </span>
                                                    ...
                                                    <div class="service-card-inner">
                                                        ...
                                                        <?php if(!empty($content->purchase_link)): ?>
                                                            <a href="<?php echo e(url($content->purchase_link)); ?>"
                                                                ...
                                                                class="btn-secondary"><?php echo e($content->link_title); ?> <svg
                                        ...
                                        <ul class="btn-list">
                                            <li>
                                                <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>"
                                                    class="btn"><?php echo e(__('Save Card')); ?>
                                            ...
                                            <li>
                                                <a href="javascript:void(0)"
                                                    class="btn share-modal-toggle"><?php echo e(__('Share Card')); ?><svg
                                            ...
                                            <li>
                                                <a href="javascript:void(0)"
                                                    class="btn make-contact-modal-toggle"><?php echo e(__('Contact')); ?><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="33"
                                                        height="32" viewBox="0 0 33 32" fill="none">
                                                        <path opacity="0.4"
                                        ...
                                        <div class="greetings-desk">
                                            <div class="user-text-avatar">
                                                <img src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png')); ?>"
                                                    alt="">
                                                <div class="up-text" id="<?php echo e($stringid . '_chtml'); ?>_preview">
                                                    <?php echo stripslashes($custom_html); ?></div>
                                            </div>
                                        </div>
                                    </section>
                                <?php endif; ?>
    ...
    <script src="<?php echo e(asset('custom/theme1/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme1/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme1/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme1/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme1/index.blade.php ENDPATH**/ ?>