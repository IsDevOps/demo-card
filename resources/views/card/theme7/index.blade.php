...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('custom/theme7/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/theme7/fonts/stylesheet.css') }}">
    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('custom/theme7/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme7/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('custom/theme7/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme7/css/responsive.css') }}">
    @endif
    @if (isset($is_slug))
...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme7'][$business->theme_color]['theme_name'] }}"
        id="view_theme17">
                                                            ...
                                                            @foreach ($appoinment_hours as $k => $hour)
                                                                <div class="col-sm-6 col-12"
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input type="radio"
                                                                            id="radio-{{ $radiocount }}"
                                                                            class="app_time" name="time" data-id="@if (!empty($hour->start)) {{ $hour->start }} @else 00:00 @endif-@if (!empty($hour->end)) {{ $hour->end }} @else 00:00 @endif">
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('custom/theme7/icon/social/' . strtolower($social_key1) . '.svg') }}"
                                                        ...
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    <a href="{{ $href }}">
                                                                        <span>
                                                                            <img src="{{ asset('custom/theme7/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        @foreach ($val1 as $key2 => $val2)
                                                                            @if ($key2 == 'Address')
    ...
    <script src="{{ asset('custom/theme7/js/jquery.min.js') }}"></script>
    <script src="{{ asset('custom/theme7/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('custom/theme7/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('custom/theme7/js/custom.js') }}" defer="defer"></script>
    @endif
