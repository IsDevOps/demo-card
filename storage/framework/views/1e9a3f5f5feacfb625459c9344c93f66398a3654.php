...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme14/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme14/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />

    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme14/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme14/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme14/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme14/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme14/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme14'][$business->theme_color]['theme_name']); ?>"
            id="view_theme3">
            <div class="home-wrapper">
                <section class="home-banner-section">
                    <img class="home-banner" id="banner_preview"
                        src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/img/placeholder-image.jpg')); ?>"
                                                                    ...
                                                                    <?php if($key1 == 'Address'): ?>
                                                                        ...
                                                                        <a href="<?php echo e($href); ?>">
                                                                            <div class="contact-svg">
                                                                                <img src="<?php echo e(asset('custom/theme14/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                                    class="img-fluid">
                                                                            </div>
                            ...
                            <section class="appointment-section padding-top padding-bottom" id="appointment-div">
                                <div class="container">
                                    ...
                                    <div class="appointment-date">
                                        ...
                                        <input type="text" placeholder="<?php echo e(__('Pick a Date')); ?>"
                                            class="text-center datepicker_min">
                                    </div>
                                    <div class="pl-1 mt-0">
                                        <span class="text-danger text-center h5 span-error-date"
                                            style="<?php echo e($SITE_RTL == 'on' ? 'margin-right: 80px;' : 'margin-left: 80px;'); ?>"></span>
                                    </div>
                                    <div class="appointment-hour">
                                                ...
                                                <?php $__currentLoopData = $appoinment_hours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $hour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="radio <?php echo e($radiocount % 2 == 0 ? 'radio-left' : ''); ?>"
                                                        ...
                                                        <input id="radio-<?php echo e($radiocount); ?>" name="time"
                                                            ...
                                                            class="app_time">
                                                        <label for="radio-<?php echo e($radiocount); ?>" class="radio-label">
                                                            <?php if(!empty($hour->start)): ?>
                                                                <?php echo e($hour->start); ?>

                                                            <?php else: ?>
                                                                00:00
                                                                <?php endif; ?> - <?php if(!empty($hour->end)): ?>
                                                                    <?php echo e($hour->end); ?>
                                        ...
                                        <div class="mt-0 mb-3 col-12">
                                            <span class="text-danger text-center span-error-time"
                                                style="<?php echo e($SITE_RTL == 'on' ? 'margin-right: 46px;' : 'margin-left: 46px;'); ?>"></span>
                                        </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="more-btn">
                                        <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>" class="btn"
                                            tabindex="0">
                                            <img src="<?php echo e(asset('custom/theme14/icon/' . $color . '/folder.svg')); ?>"
                                        ...
                                        <a href="javascript:;" class="btn our-card" tabindex="0">
                                            <img src="<?php echo e(asset('custom/theme14/icon/' . $color . '/signout.svg')); ?>"
                                        ...
                                        <a href="javascript:;" class="btn our-contact" tabindex="0">
                                            <img src="<?php echo e(asset('custom/theme14/icon/' . $color . '/phone.svg')); ?>"
                                                alt="signout" class="img-fluid">
                                            &nbsp;
                                                ...
                                                <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li>
                                                                <div class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                    ...
                                                                    <a href="<?php echo e($social_links); ?>"
                                                                        ...
                                                                        target="_blank">
                                                                        <img src="<?php echo e(asset('custom/theme14/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
                                    ...
                                    <a href="https://twitter.com">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <rect x="0.75" y="0.75" width="18.5" height="18.5"
                                                rx="3.25" stroke="black" stroke-width="1.5" />
                                        </svg>
                                    </a>
                                </li>
                                <li>
                ...
                <div class="container">
                    <form class="appointment-form-wrapper contact-form-wrapper">
                        <div class="section-title">
                            ...
                            <div class="close-search">
                                <img src="<?php echo e(asset('custom/theme14/icon/' . $color . '/close.svg')); ?>"
    ...
    <script src="<?php echo e(asset('custom/theme14/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme14/js/slick.min.js')); ?>" defer="defer"></script>

    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme14/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme14/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme14/index.blade.php ENDPATH**/ ?>