...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/fonts/stylesheet.css')); ?>">

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme10'][$business->theme_color]['theme_name']); ?>"
        id="view_theme20">
        <main id="boxes">
                    ...
                    <div class="bussiness-card-body">
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-name">
                                        <h3 class="text-white" id="<?php echo e($stringid . '_title'); ?>_preview">
                                            <?php echo e($business->title); ?></h3>
                                        <p id="<?php echo e($stringid . '_designation'); ?>_preview">
                                            <?php echo e($business->designation); ?></b>
                                        </p>
                            ...
                            <?php if($j == $order_value): ?>
                                <?php if($order_key == 'appointment'): ?>
                                    <section class="make-appointment" id="appointment-div">
                                        <div class="section-title text-center">
                                            <h2 class="text-white"><?php echo e(__('Make')); ?> <br> <?php echo e(__('an appointment')); ?>
                                                                ...
                                                                <div class="col-sm-6 col-12"
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input type="radio"
                                                                            ...
                                                                            class="app_time" name="time" data-id="<?php if(!empty($hour->start)): ?> <?php echo e($hour->start); ?> <?php else: ?> 00:00 <?php endif; ?>-<?php if(!empty($hour->end)): ?> <?php echo e($hour->end); ?> <?php else: ?> 00:00 <?php endif; ?>">
                                                            ...
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                <?php if($key1 == 'Address'): ?>
                                                                    ...
                                                                    <a href="<?php echo e($href); ?>">
                                                                        <span>
                                                                            <img src="<?php echo e(asset('custom/theme10/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($key2 == 'Address'): ?>
                                ...
                                <?php if($order_key == 'service'): ?>
                                    <section class="service-section" id="services-div">
                                        <div class="section-title">
                                            <h2 class="text-white"><?php echo e(__('Services')); ?> </h2>
                                        </div>
                                ...
                                <?php if($order_key == 'gallery'): ?>
                                    <section class="gallery-section" id="gallery-div">
                                        <div class="section-title text-center">
                                            <h2 class="text-white"><?php echo e(__('Gallery')); ?></h2>
                                        </div>
                                ...
                                <?php if($order_key == 'testimonials'): ?>
                                    <section class="testimonial-section text-center" id="testimonials-div">
                                        <div class="section-title">
                                            <h2 class="text-white"><?php echo e(__('Testimonials')); ?></h2>
                                        </div>
                                        <?php if(isset($is_pdf)): ?>
                                ...
                                <?php if($order_key == 'social'): ?>
                                    <section class="social" id="social-div">
                                        <div class="section-title text-center">
                                            <h2 class="text-white"><?php echo e(__('Social')); ?></h2>
                                        </div>
                                                        ...
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <a href="<?php echo e($social_links); ?>" target="_blank"
                                                                    ...
                                                                    <img src="<?php echo e(asset('custom/theme10/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
                                ...
                                <?php if($order_key == 'more'): ?>
                                    <section class="more-info">
                                        <div class="section-title text-center">
                                            <h2 class="text-white"><?php echo e(__('More')); ?></h2>
                                        </div>
                                        <ul class="btn-list">
                                            <li>
                        ...
                        <?php if($is_branding_enabled): ?>
                            <div class="is_branding_enable copy-right" id="is_branding_enabled">
                                <p id="<?php echo e($stringid . '_branding'); ?>_preview"><?php echo e($business->branding_text); ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="social-list modal-share">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/" class="linked-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55"
                                        viewBox="0 0 55 55" fill="none">
        ...
        <div class="theme-modal contact-modal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="btn-close make-contact-modal-toggle close-search2  ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45"
                                viewBox="0 0 45 45" fill="none">
                                <path opacity="0.4"
                                    d="M37.2376 24.5509H7.76834C6.74981 24.5509 5.92651 23.7258 5.92651 22.7091C5.92651 21.6924 6.74981 20.8672 7.76834 20.8672H37.2376C38.2561 20.8672 39.0794 21.6924 39.0794 22.7091C39.0794 23.7258 38.2561 24.5509 37.2376 24.5509Z"
    ...
    <script src="<?php echo e(asset('custom/theme10/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme10/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme10/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme10/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme10/index.blade.php ENDPATH**/ ?>