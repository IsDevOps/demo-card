...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/fonts/stylesheet.css')); ?>">

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme9'][$business->theme_color]['theme_name']); ?>"
        id="view_theme19">
        <main id="boxes">
                                                        ...
                                                        <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                            <?php if($key1 == 'Address'): ?>
                                                                ...
                                                                <a href="<?php echo e($href); ?>">
                                                                    <span>
                                                                        <img src="<?php echo e(asset('custom/theme9/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                            class="img-fluid">
                                                                    </span>
                                                                    <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($key2 == 'Address'): ?>
                                                        ...
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <a href="<?php echo e($social_links); ?>" target="_blank"
                                                                    ...
                                                                    <img src="<?php echo e(asset('custom/theme9/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
    ...
    <script src="<?php echo e(asset('custom/theme9/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme9/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme9/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme9/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme9/index.blade.php ENDPATH**/ ?>