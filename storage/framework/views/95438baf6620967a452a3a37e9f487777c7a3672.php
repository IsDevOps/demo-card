...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme16/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme16/fonts/stylesheet.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />

    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme16/modal/bootstrap.min.css')); ?>">
    <?php endif; ?>

    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme16/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme16/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme16/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme16/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme16'][$business->theme_color]['theme_name']); ?>"
            id="view_theme5">
                    ...
                    <div class="container">
                        <div class="client-info-wrapper">
                            ...
                            <div class="client-brief-info">
                                ...
                                <h6 id="<?php echo e($stringid . '_designation'); ?>_preview">
                        ...
                        <p id="<?php echo e($stringid . '_desc'); ?>_preview" class="client-text">
                                                ...
                                                <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                    ...
                                                    <div>
                                                        <a href="<?php echo e($social_links); ?>"
                                                            ...
                                                            target="_blank">
                                                            <img src="<?php echo e(asset('custom/theme16/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg')); ?>"
                                                                    ...
                                                                    <?php if($key1 == 'Address'): ?>
                                                                        ...
                                                                        <a href="<?php echo e($href); ?>"
                                                                            ...
                                                                            <div class="contact-svg">
                                                                                <img src="<?php echo e(asset('custom/theme16/icon/' . $color . '/contact/' . strtolower($key1) . '.svg')); ?>"
                                                                                    class="img-fluid">
                        ...
                        <?php if($order_key == 'more'): ?>
                            <section class="more-card-second-section">
                                <div class="container">
                                    <div class="more-card-btn">
                                        <a href="javascript:;" class="btn" tabindex="0"
                                            onclick="location.href = 'https://versecards.co'">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="19"
                                                viewBox="0 0 22 19" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M10.8676 5.41797L9.6954 3.46428C9.39795 2.96852 8.94858 2.68502 8.49937 2.62776C7.63403 2.51745 6.55518 2.41797 5.5 2.41797C4.76672 2.41797 4.0186 2.46607 3.33466 2.5334C2.70504 2.59538 2.24029 3.06309 2.19011 3.71721C2.08968 5.02657 2 6.90062 2 9.41797C2 11.1906 2.06456 12.7695 2.14656 14.0596C2.22311 15.2638 3.13628 16.1727 4.34979 16.2427C5.99648 16.3376 8.2132 16.418 11 16.418C13.7868 16.418 16.0035 16.3376 17.6502 16.2427C18.8637 16.1727 19.7769 15.2638 19.8534 14.0596C19.9354 12.7695 20 11.1906 20 9.41797C20 8.45184 19.944 7.53469 19.8699 6.74589C19.8087 6.09488 19.3231 5.60922 18.6721 5.54806C17.8833 5.47396 16.9661 5.41797 16 5.41797H10.8676ZM12 3.41797L11.4104 2.43529C10.8306 1.46891 9.87021 0.786322 8.75227 0.643814C7.83875 0.527364 6.66937 0.417969 5.5 0.417969C4.68392 0.417969 3.86784 0.471247 3.13873 0.543021C1.53169 0.701216 0.319474 1.95417 0.19597 3.56425C0.0913573 4.92805 0 6.85326 0 9.41797C0 11.2385 0.0662874 12.8602 0.150591 14.1865C0.291559 16.4042 2.01613 18.1114 4.23467 18.2394C5.91963 18.3365 8.17474 18.418 11 18.418C13.8253 18.418 16.0804 18.3365 17.7653 18.2394C19.9839 18.1114 21.7084 16.4042 21.8494 14.1865C21.9337 12.8602 22 11.2385 22 9.41797C22 8.37683 21.9398 7.39592 21.8611 6.55882C21.7101 4.95109 20.4669 3.70787 18.8591 3.55683C18.0221 3.47819 17.0411 3.41797 16 3.41797H12Z"
    ...
    <script src="<?php echo e(asset('custom/theme16/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme16/js/slick.min.js')); ?>" defer="defer"></script>

    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme16/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme16/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme16/index.blade.php ENDPATH**/ ?>