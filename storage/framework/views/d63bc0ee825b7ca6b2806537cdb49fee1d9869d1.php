...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/libs/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/fonts/stylesheet.css')); ?>">
    <?php if($SITE_RTL == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/css/rtl-main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/css/rtl-responsive.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/css/main-style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/css/responsive.css')); ?>">
    <?php endif; ?>
...
<body class="tech-card-body ">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme2'][$business->theme_color]['theme_name']); ?>"
        id="view_theme12">
        <main id="boxes">
                    ...
                    <div class="bussiness-card-body">
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-name">
                                        <h3 id="<?php echo e($stringid . '_title'); ?>_preview" class="text-white">
                                            <?php echo e($business->title); ?></h3>
                                        <p id="<?php echo e($stringid . '_designation'); ?>_preview" class="text-white">
                                            <?php echo e($business->designation); ?>

                                        </p>
                                        <h6 id="<?php echo e($stringid . '_subtitle'); ?>_preview" class="text-white">
                                            <?php echo e($business->sub_title); ?></h6>
                                    </div>
                                </div>
                                <div class="text-center desc-wrapper">
                                    <p id="<?php echo e($stringid . '_desc'); ?>_preview" class="text-white">
                                        <?php echo e($business->description); ?></h3>
                                </div>
                            </div>
                        </section>
                        <?php $j = 1; ?>
                            ...
                            <?php if($j == $order_value): ?>
                                                            ...
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                <?php if($key1 == 'Address'): ?>
                                                                    ...
                                                                    <a href="<?php echo e($href); ?>" target="_blank">
                                                                        <span>
                                                                            <img src="<?php echo e(asset('custom/theme2/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($key2 == 'Address'): ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <div id="<?php echo e($key1 . '_' . $no); ?>_preview">
                                                                        <?php echo e($val1); ?></div>
                                                                    </a>
                                                                <?php endif; ?>
                                                            </li>
                                ...
                                <?php if($order_key == 'bussiness_hour'): ?>
                                    <section class="bussiness-hour" id="business-hours-div">
                                        <div class="section-title">
                                            <h2 class="text-white"><?php echo e(__('Business Hours')); ?> </h2>
                                        </div>
                                        <div class="d-flex justify-content-center daily-hours-inner">
                                            <ul class="hours-list">
                                    ...
                                    <section class="make-appointment" id="appointment-div">
                                        ...
                                        <div class="appointment-form">
                                            ...
                                            <div class="text-center">
                                                <button class="btn hover-secondary appointment-modal-toggle">
                                                    <?php echo e(__('Make an appointment')); ?></button>
                                            </div>
                                        </div>
                                    </section>
                                <?php endif; ?>
                                        ...
                                        <div id="inputrow_gallery_preview">
                                            ...
                                            <?php else: ?>
                                                <div class="gallery-slider">
                                                    <?php if(!is_null($gallery_contents) && !is_null($gallery)): ?>
                                                        <?php $__currentLoopData = $gallery_contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $gallery_content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div id="gallery_<?php echo e($gallery_row_no); ?>">
                                ...
                                <?php if($order_key == 'social'): ?>
                                    <section class="card-footer" id="social-div">
                                        <div class="section-title text-center">
                                                        ...
                                                        <?php if($social_key1 != 'id'): ?>
                                                            <li class="socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                ...
                                                                <a href="<?php echo e($social_links); ?>" target="_blank"
                                                                    ...
                                                                    <img src="<?php echo e(asset('custom/theme2/icon/social/' . strtolower($social_key1) . '.svg')); ?>"
                                ...
                                <?php if($order_key == 'custom_html'): ?>
                                    <section class="custom_html_text">
                                        <div class="greetings-desk">
                                            <div class="user-text-avatar" id="<?php echo e($stringid . '_chtml'); ?>_preview">
                        ...
                        <?php if($is_branding_enabled): ?>
                            <div class="card-footer">
                                <div id="is_branding_enabled" class="is_branding_enable copy-right">
                                    <p id="<?php echo e($stringid . '_branding'); ?>_preview">
                                        <?php echo e($business->branding_text); ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="social-list modal-share">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/" class="linkdin-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55"
                                        viewBox="0 0 55 55" fill="none">
        ...
        <div class="theme-modal appointment-modal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close-search1 btn-close appointment-modal-toggle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45"
                                viewBox="0 0 45 45" fill="none">
                                <path opacity="0.4"
                                    d="M37.2376 24.5509H7.76834C6.74981 24.5509 5.92651 23.7258 5.92651 22.7091C5.92651 21.6924 6.74981 20.8672 7.76834 20.8672H37.2376C38.2561 20.8672 39.0794 21.6924 39.0794 22.7091C39.0794 23.7258 38.2561 24.5509 37.2376 24.5509Z"
        ...
        <div class="theme-modal contact-modal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close-search2 btn-close make-contact-modal-toggle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45"
                                viewBox="0 0 45 45" fill="none">
                                <path opacity="0.4"
                                    d="M37.2376 24.5509H7.76834C6.74981 24.5509 5.92651 23.7258 5.92651 22.7091C5.92651 21.6924 6.74981 20.8672 7.76834 20.8672H37.2376C38.2561 20.8672 39.0794 21.6924 39.0794 22.7091C39.0794 23.7258 38.2561 24.5509 37.2376 24.5509Z"
    ...
    <!--scripts start here-->
    <script src="<?php echo e(asset('custom/theme2/js/jquery.min.js')); ?>"></script>

    <script src="<?php echo e(asset('custom/theme2/js/slick.min.js')); ?>" defer="defer"></script>
    <?php if($SITE_RTL == 'on'): ?>
        <script src="<?php echo e(asset('custom/theme2/js/rtl-custom.js')); ?>" defer="defer"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('custom/theme2/js/custom.js')); ?>" defer="defer"></script>
    <?php endif; ?>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme2/index.blade.php ENDPATH**/ ?>