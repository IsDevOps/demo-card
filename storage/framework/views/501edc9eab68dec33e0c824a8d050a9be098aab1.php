...
<body class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme12'][$business->theme_color]['theme_name']); ?>"
            id="view_css">
            <!--wrapper start here-->
                    ...
                    <?php if($j == $order_value): ?>
                        ...
                        <?php if($order_key == 'bussiness_hour'): ?>
                            <section class="business-hour-section padding-top padding-bottom" id="business-hours-div">
                                <div class="title-svg">
                                    <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/clock.svg')); ?>"
						...
						<?php if($order_key == 'leadgeneration'): ?>
                            <section class="more-card-section padding-bottom" style="background: linear-gradient(180deg, rgb(237 237 237) 0%, rgb(238 238 238) 100%);border-radius: 0 0 0 0;">
                                ...
                                <div class="container">
                                    ...
                                    <div class="more-btn">
                                        ...
                                        <?php $__currentLoopData = $leadGeneration_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leadgen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
											...
											<a href="javascript:;" class="btn lead-generation<?php echo e($leadgen->id); ?>" tabindex="0">
												<img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/phone.svg')); ?>"
                        ...
                        <?php if($order_key == 'gallery'): ?>
                            <section class="gallery-section padding-top padding-bottom" id="gallery-div">
                                <div class="title-svg">
                                    <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/gallery.svg')); ?>"
                                        alt="phone" class="img-fluid">
                                </div>
                                <div class="container">
                                    <div class="section-title text-center">
                    ...
                    <form class="appointment-form-wrapper">
                        <div class="section-title">
                            ...
                            <div class="close-search">
                                <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/close.svg')); ?>"
	...
	<div class="add-to-contact-wrapper " style="position: fixed;bottom: 10px;left: 50%;transform: translateX(-50%);z-index: 999999">
        <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>" class="btn btn-primary add-to-contact-btn add-to-contact-botton" ><i class="fa fa-address-card"></i>&nbsp; Add to Contact</a>
    </div>
	...
	<?php $__currentLoopData = $leadGeneration_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leadgen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
		<div class="leadgeneration-popup<?php echo e($leadgen->id); ?>">
                <div class="container">
                    <form class="appointment-form-wrapper contact-form-wrapper">
                        <div class="section-title">
                            <h5><?php echo e(__($leadgen->title)); ?></h5>
                            <div class="close-search">
                                <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/close.svg')); ?>"
                                    alt="back" class="img-fluid">
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name<?php echo e($leadgen->id); ?>" placeholder="<?php echo e(__('Enter your name')); ?>"
										...
										<input type="text" name="campaign_id<?php echo e($leadgen->id); ?>" class="form-control campaign_id<?php echo e($leadgen->id); ?>" value = "<?php echo e($leadgen->id); ?>">
                                    <div class="">
            ...
            if (name == "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        show_toastr('Success', "<?php echo e(__('Your contact detail have been saved.')); ?>",
                            'success');
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/card/theme12/index.blade.php ENDPATH**/ ?>