                                            ...
                                            <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Subject : ').'Ragarding new appointment.'); ?></b></p>
                                                                <p style="line-height:32px"><b style="font-weight:700"><?php echo e(__('Hi Dear,')); ?></b></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;"><?php echo e($appointment->name); ?><?php echo e(__(' has booked an appointment for ')); ?><?php echo e($appointment->date); ?><?php echo e(__(' at ')); ?><?php echo e($appointment->time); ?><?php echo e(__('.')); ?></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;"><i style="font-style:normal"><?php echo e(__('Email: ')); ?><?php echo e($appointment->email); ?></i></p>
                                                                <p style="margin: 10px 0;"><i style="font-style:normal"><?php echo e(__('Phone Number: ')); ?><?php echo e($appointment->phone); ?></i></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                ...
                                                                <p style="margin: 10px 0;"><i style="font-style:normal"><b style="font-weight:700"><?php echo e((isset(\Utility::settings()['company_name']) && !empty(\Utility::settings()['company_name']))?\Utility::settings()['company_name']:env('APP_NAME')); ?></b></i></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
...
<?php /**PATH /home/oseghale/Documents/ehis/demo/resources/views/email/appointment_create.blade.php ENDPATH**/ ?>